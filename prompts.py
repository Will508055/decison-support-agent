...
only selecting one value from the list of values for each key: 
{{ 
'curve_sharpness': ['slight left', 'smooth left', 'sharp left', 'slight right', 'smooth right','sharp right', 'straight'], 
'visible_curve_length': ['fully visible', 'end obstructed', 'mostly obstructed'], 
'oncoming_traffic': ['present', 'possible', 'only same direction', 'single lane'] 
}}'''